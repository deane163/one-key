 ...
 *
 */
package com.xinyi.xframe.dubbo_onekey_api.declare;
 ...
 * MySearchOption.java
 * 
 * Original Author: liangliang.jia,2015年7月28日上午10:42:37
 * 
...
public class MySearchOption implements Serializable {
    ...
    */
	...
	public static String formatDate(Object object) {
		...
		return MySearchOption.formatDateFromString(String.valueOf(object));
	}

	public static boolean isDate(Object object) {
		return object instanceof java.util.Date
				|| Pattern.matches("[1-2][0-9][0-9][0-9]-[0-9][0-9].*",String.valueOf(object));
	}
